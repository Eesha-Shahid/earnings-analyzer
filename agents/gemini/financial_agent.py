...
Focus on: revenue, gross margin, operating margin, net income, EPS, and guidance.
Include the chunk_id for every extraction so we can cite sources."""
